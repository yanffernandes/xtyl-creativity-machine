...
- [ ] T019 [US1] Integrate useImageVariations hook with existing chat SSE handler in frontend/src/hooks/useChat.ts
- [ ] T020 [US1] Render ImageVariationGrid when variation events received in frontend/src/components/chat/ChatMessage.tsx
...
- [ ] T029 [US2] Add ImageGenerationSettings to admin settings page in frontend/src/app/admin/settings/page.tsx
...
- [ ] T032 [US3] Review existing visual_asset_service.py for asset retrieval in backend/services/visual_asset_service.py
- [ ] T033 [US3] Update prompt enrichment to inject visual context from project assets in backend/services/prompt_enrichment_service.py
- [ ] T034 [US3] Add visual_assets_used to generation metadata in backend/tools.py
- [ ] T035 [US3] Ensure brand colors and style references are passed to image generation prompt in backend/services/prompt_enrichment_service.py
- [ ] T036 [US3] Handle case when project has no visual assets (use generic marketing best practices) in backend/services/prompt_enrichment_service.py
...
- [ ] T037 [US4] Update system prompt to recognize override patterns in backend/services/llm_service.py or chat context
- [ ] T038 [US4] Add skip_prompt_enrichment parameter handling in backend/tools.py
- [ ] T039 [US4] Add override_variations parameter handling in backend/tools.py
- [ ] T040 [US4] Add skip_visual_context parameter handling in backend/tools.py
- [ ] T041 [US4] Document override patterns ("exatamente isso:", "apenas X variação", "sem referências") in system prompt
...
- [ ] T042 [P] Add GET /documents/variation-set/{variation_set_id} endpoint in backend/routers/documents.py
- [ ] T043 [P] Add index on variation_set_id column for efficient queries (verify in migration)
- [ ] T044 Log generation metadata (variations_requested, modifier_applied, timing) in backend/tools.py
- [ ] T045 Add error boundary for ImageVariationGrid in frontend/src/components/chat/ImageVariationGrid.tsx
- [ ] T046 Verify quickstart.md scenarios work end-to-end
