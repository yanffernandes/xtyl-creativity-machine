-- =============================================================================
-- Migration 020: Enable RLS Policies for Hybrid Supabase Architecture
-- Feature: 007-hybrid-supabase-architecture
-- Date: 2025-12-04
--
-- IMPORTANT: This migration enables Row Level Security on all tables and
-- creates the necessary policies for frontend direct access to Supabase.
-- =============================================================================
