...
function convertFormatsToIntlMessageFormat(globalFormats, inlineFormats, timeZone) {
  ...
  const dateTimeFormats = {
    ...globalFormats == null ? void 0 : globalFormats.dateTime,
    ...inlineFormats == null ? void 0 : inlineFormats.dateTime
  };
  const allFormats = {
    date: {
      ...mfDateDefaults,
    ...
    number: {
      ...globalFormats == null ? void 0 : globalFormats.number,
      ...inlineFormats == null ? void 0 : inlineFormats.number
    }
  ...
  Object.keys(values).forEach((key) => {
    ...
    if (typeof value === "function") {
      transformed = (chunks) => {
        ...
        return (0, import_react.isValidElement)(result) ? (0, import_react.cloneElement)(result, {
          key: key + index++
        }) : result;
      };
    } else {
...
function getPlainMessage(candidate, values) {
  return (
    ...
    /<|{/.test(candidate) ? void 0 : candidate
  );
}
...
function createBaseTranslatorImpl({
  ...
  function translateBaseFn(key, values, formats, _fallback) {
    ...
    try {
      ...
      return (0, import_react.isValidElement)(formattedMessage) || // Arrays of React elements
...
function createFormatter(props) {
  ...
  function dateTime(value, formatOrOptions, overrides) {
    return getFormattedValue(formatOrOptions, overrides, formats == null ? void 0 : formats.dateTime, (options) => {
  ...
  function number(value, formatOrOptions, overrides) {
    return getFormattedValue(formatOrOptions, overrides, formats == null ? void 0 : formats.number, (options) => formatters.getNumberFormat(locale, options).format(value), () => String(value));
  }
...
var IntlContext = (0, import_react2.createContext)(void 0);
function IntlProvider({
  ...
  const prevContext = (0, import_react2.useContext)(IntlContext);
  const cache = (0, import_react2.useMemo)(() => {
    return (prevContext == null ? void 0 : prevContext.cache) || createCache();
  }, [locale, prevContext == null ? void 0 : prevContext.cache]);
  const formatters = (0, import_react2.useMemo)(() => (prevContext == null ? void 0 : prevContext.formatters) || createIntlFormatters(cache), [cache, prevContext == null ? void 0 : prevContext.formatters]);
  const value = (0, import_react2.useMemo)(() => ({
    ...initializeConfig({
      locale,
      // (required by provider)
      formats: formats === void 0 ? prevContext == null ? void 0 : prevContext.formats : formats,
      getMessageFallback: getMessageFallback || (prevContext == null ? void 0 : prevContext.getMessageFallback),
      messages: messages === void 0 ? prevContext == null ? void 0 : prevContext.messages : messages,
      now: now || (prevContext == null ? void 0 : prevContext.now),
      onError: onError || (prevContext == null ? void 0 : prevContext.onError),
      timeZone: timeZone || (prevContext == null ? void 0 : prevContext.timeZone)
    }),
    formatters,
    cache
  }), [cache, formats, formatters, getMessageFallback, locale, messages, now, onError, prevContext, timeZone]);
  return (0, import_jsx_runtime.jsx)(IntlContext.Provider, {
    value,
    children
  });
}
function useIntlContext() {
  const context = (0, import_react2.useContext)(IntlContext);
  if (!context) {
...
function useTranslationsImpl(allMessagesPrefixed, namespacePrefixed, namespacePrefix) {
  ...
  const translate = (0, import_react2.useMemo)(() => createBaseTranslator({
    cache,
    formatters,
    getMessageFallback,
...
function useNow(options) {
  const updateInterval = options == null ? void 0 : options.updateInterval;
  const {
    now: globalNow
  } = useIntlContext();
  const [now, setNow] = (0, import_react2.useState)(globalNow || getNow());
...
function useFormatter() {
  ...
  return (0, import_react2.useMemo)(() => createFormatter({
    formats,
    locale,
    now: globalNow,
    onError,
...
function useExtracted(namespace) {
  ...
  translateFn.has = function translateHasFn(message) {
    return true;
  };
  return translateFn;
}
...
var useTranslations2 = callHook("useTranslations", useTranslations);
var useFormatter2 = callHook("useFormatter", useFormatter);
...
function NextIntlClientProvider({
  ...
  return (0, import_jsx_runtime2.jsx)(IntlProvider, {
    locale,
    ...rest
  });
}
export {
  ...
  createIntlFormatters as _createIntlFormatters,
  createFormatter,
  createTranslator,
  hasLocale,
  initializeConfig,
  useExtracted,
  useFormatter2 as useFormatter,
  useLocale,
  useMessages,
  useNow,
  useTimeZone,
  useTranslations2 as useTranslations
};
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=next-intl.js.map
