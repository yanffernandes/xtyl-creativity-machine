...
export const documentsApi = {
  ...
  moveToBoard: async (documentId: string, boardId: string | null, boardColumnId: string | null, boardPosition?: number | null) => {
    const { data, error } = await documentService.moveToBoard(documentId, boardId, boardColumnId, boardPosition ?? null)
    if (error) throw error
    return data
  },
