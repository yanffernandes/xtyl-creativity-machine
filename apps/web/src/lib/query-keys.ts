...
export const queryKeys = {
  workspaces: {
    ...
    members: (id: string) =>
      [...queryKeys.workspaces.all, 'members', id] as const,
  },
  ...
  projects: {
    ...
    byWorkspace: (workspaceId: string) =>
      [...queryKeys.projects.lists(), 'workspace', workspaceId] as const,
    detail: (id: string) =>
  ...
  templates: {
    ...
    byWorkspace: (workspaceId: string) =>
      [...queryKeys.templates.lists(), 'workspace', workspaceId] as const,
    system: () => [...queryKeys.templates.lists(), 'system'] as const,
    user: () => [...queryKeys.templates.lists(), 'user'] as const,
    byCategory: (category: string) =>
      [...queryKeys.templates.lists(), 'category', category] as const,
    detail: (id: string) =>
  ...
  visualAssets: {
    ...
    byProject: (projectId: string) =>
      [...queryKeys.visualAssets.all, 'project', projectId] as const,
    detail: (id: string) =>
      [...queryKeys.visualAssets.all, 'detail', id] as const,
  },

  conversations: {
    all: ['conversations'] as const,
    byProject: (projectId: string) =>
      [...queryKeys.conversations.all, 'project', projectId] as const,
    detail: (id: string) =>
  ...
  workflows: {
    ...
    byProject: (projectId: string) =>
      [...queryKeys.workflows.all, 'project', projectId] as const,
    detail: (id: string) =>
  ...
  memories: {
    all: (projectId: string) =>
      ['memories', 'project', projectId] as const,
    lists: (projectId: string) =>
      [...queryKeys.memories.all(projectId), 'list'] as const,
  ...
  visualSettings: {
    ...
    byProject: (projectId: string) =>
      [...queryKeys.visualSettings.all, 'project', projectId] as const,
  },

  assetSelections: {
    all: ['assetSelections'] as const,
    byProject: (projectId: string) =>
      [...queryKeys.assetSelections.all, 'project', projectId] as const,
  },

  imageBatch: {
    all: ['imageBatch'] as const,
    status: (batchId: string) =>
      [...queryKeys.imageBatch.all, 'status', batchId] as const,
  },
  ...
  images: {
    ...
    byProject: (projectId: string) =>
      [...queryKeys.images.lists(), 'project', projectId] as const,
    detail: (imageId: string) =>
      [...queryKeys.images.all, 'detail', imageId] as const,
    byVariationSet: (variationSetId: string) =>
      [...queryKeys.images.all, 'variationSet', variationSetId] as const,
  },
  ...
  documentAttachments: {
    ...
    byDocument: (documentId: string) =>
      [
        ...queryKeys.documentAttachments.all,
        'document',
        documentId,
      ] as const,
  },
  ...
  copyLibrary: {
    ...
    byWorkspace: (workspaceId: string) =>
      [...queryKeys.copyLibrary.lists(), 'workspace', workspaceId] as const,
