...
export function CopyLibraryDrawer({
  ...
  const { data, isLoading } = useCopyLibrary(workspaceId, {
    ...
    <>
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent className="w-full sm:max-w-lg">
          <SheetHeader>
            ...
            <SheetDescription>
              Reusable text snippets for image generation
            </SheetDescription>
          </SheetHeader>
                ...
                {isLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="mt-4 text-sm text-muted-foreground">
                      {search
                        ? 'No copies found'
                        : 'Library is empty. Create your first copy!'}
                    </p>
                    {!search && (
                      <Button
                        variant="outline"
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle>
              {editingCopy ? 'Edit copy' : 'New copy'}
            </DialogTitle>
            <DialogDescription>
              {editingCopy
                ? 'Edit the copy details'
                : 'Create a new copy to reuse as a prompt'}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                id="title"
                placeholder="E.g. Black Friday CTA"
