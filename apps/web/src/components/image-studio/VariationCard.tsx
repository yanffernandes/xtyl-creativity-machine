...
export const VariationCard = memo(function VariationCard({
  ...
  if (isGenerating && !variation.success && !variation.error) {
    return (
      <motion.div
        ...
        className={cn(
          'relative aspect-square rounded-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 flex items-center justify-center',
          className
        )}
      >
  ...
  if (variation.error) {
    return (
      <motion.div
        ...
        animate={{ opacity: 1, scale: 1 }}
        className={cn(
          'relative aspect-square rounded-xl overflow-hidden bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 flex items-center justify-center p-4',
          className
        )}
      >
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group relative aspect-square rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-800 ring-1 ring-black/5 dark:ring-white/10 cursor-pointer',
        className
      )}
    >
      {variation.file_url && (
      ...
      >
        ...
        <div className="absolute top-2 right-2 flex gap-1">
          ...
          <Tooltip>
            ...
            <TooltipContent>{isSaved ? 'Salvo!' : 'Salvar'}</TooltipContent>
          </Tooltip>
