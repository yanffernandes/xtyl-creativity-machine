 ...
 *
 * A rich text input for image generation prompts with
 * character count, suggestions, and auto-resize.
 */
  ...
  return (
    <div className={cn('space-y-3', className)}>
      ...
      <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
        <span>
          Pressione <kbd className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 font-mono">⌘</kbd>
          {' + '}
