...
/**
 * ConceptGrid Component
 * Feature 031: Creative Concepts Migration
 *
 * Displays a horizontal scrollable grid of creative concepts with
 * "None" option.
 */
...
export function ConceptGrid({
  ...
  // Sort concepts by sort_order
  const sortedConcepts = [...concepts].sort((a, b) => a.sort_order - b.sort_order);
        ...
        <div className="flex items-center gap-2 text-sm font-medium text-gray-600 dark:text-gray-400">
          ...
          {selectedConceptSlug && (
            <span className="text-blue-500">
              ({sortedConcepts.find((c) => c.slug === selectedConceptSlug)?.name_pt || selectedConceptSlug})
            </span>
          )}
        </div>
