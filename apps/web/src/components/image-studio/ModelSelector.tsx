  ...
  return (
    <div className={cn('space-y-2', className)}>
      ...
      <Select value={value} onValueChange={onChange} disabled={disabled}>
        <SelectTrigger
          className={cn(
            'w-full bg-white/50 dark:bg-gray-900/50 border-gray-200/50 dark:border-gray-700/50 backdrop-blur-xl'
          )}
        >
            ...
            {selectedModel && (
              <span className="flex items-center gap-2">
                ...
                {selectedModel.top_provider && (
                  <span className="text-xs text-gray-400">({selectedModel.top_provider})</span>
                )}
              </span>
            )}
          </SelectValue>
